...
from .views import (
    ...
    , ListaPropietariosInquilinosView
)
...
urlpatterns = [
    ...
    # Endpoint para móvil y frontend: lista de usuarios activos
    path('api/seguridad/lista-usuarios-activos/', ListaUsuariosActivosView.as_view(), name='lista-usuarios-activos-movil'),
        # Endpoint para propietarios e inquilinos activos
    path('lista-propietarios-inquilinos/', ListaPropietariosInquilinosView.as_view(), name='lista-propietarios-inquilinos'),
